...
public class LogrepositNamingConvention implements NamingConvention
{
     ...
     */
    public LogrepositNamingConvention() {
        this(NamingConvention.snakeCase);
    }

    public LogrepositNamingConvention(NamingConvention delegate) {
